...
public class SqlHelper {  
    ...
    private static java.io.InputStream fis = null;  
    ...
    static {  
        try {  
            ...
            String filename = "com/db/dbinfo.properties"; 
            pp = new Properties();  
            pp.load(SqlHelper.class.getClassLoader().getResourceAsStream(filename));
